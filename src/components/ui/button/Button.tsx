...
const Button: React.FC<ButtonProps> = ({
 ...
 fellowship:"bg-pic-yellow text-fellowship-navy shadow-theme-xs hover:bg-pic-yellow-hover disabled:bg-pic-yellow-disabled disabled:text-fellowship-navy/60",
 };
