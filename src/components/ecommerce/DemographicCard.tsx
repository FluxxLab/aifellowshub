...
export default function DemographicCard() {
 ...
 <div className="px-4 py-6 my-6 overflow-hidden border border-gary-200 rounded-2xl bg-gray-50 sm:px-6">
 <div
 id="mapOne" className="mapOne map-btn -mx-4 -my-6 h-[212px] w-[252px] 2xsm:w-[307px] xsm:w-[358px] sm:-mx-6 md:w-[668px] lg:w-[634px] xl:w-[393px] 2xl:w-[554px]">
 <CountryMap />
 </div>
 </div>
 ...
 width={48}
 height={48}
 src="/images/country/country-01.svg" alt="usa" className="w-full"/>
 </div>
 <div>
 ...
 width={48}
 height={48}
 className="w-full" src="/images/country/country-02.svg" alt="france"/>
 </div>
 <div>
 <p className="font-semibold text-gray-800 text-theme-sm">
 France
