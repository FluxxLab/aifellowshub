...
const Calendar: React.FC = () => {
 ...
 <input
 id="event-title" type="text" value={eventTitle}
 ...
 >
 <label
 className="flex items-center text-sm text-gray-700 form-check-label" htmlFor={`modal${key}`}
 >
 <span className="relative">
 <input
 className="sr-only form-check-input" type="radio" name="event-level" value={key}
 id={`modal${key}`}
 ...
 <input
 id="event-start-date" type="date" value={eventStartDate}
 ...
 <div className="relative">
 <input
 id="event-end-date" type="date" value={eventEndDate}
 ...
 <button
 onClick={closeModal}
 type="button" className="flex w-full justify-center rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 sm:w-auto">
 Close
 </button>
 <button
 onClick={handleAddOrUpdateEvent}
 type="button" className="btn btn-success btn-update-event flex w-full justify-center rounded-lg bg-brand-500 px-4 py-2.5 text-sm font-medium text-white hover:bg-brand-600 sm:w-auto">
